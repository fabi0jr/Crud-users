...
import { paginateRaw, type Pagination } from 'nestjs-typeorm-paginate';
...
export class UsersService {
  ...
  async findAll(options: SearchUserDto): Promise<Pagination<User>> {
    const { search, page = 1, limit = 10 } = options; // Valores padrão para page e limit
    ...
    // Use paginateRaw para trabalhar com queryBuilder
    return paginateRaw<User>(queryBuilder, { page, limit });
  }
